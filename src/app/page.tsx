    ...
    <div style={{
      ...
      <header className="ff-header" style={{
        ...
        <div style={{ display: "flex", gap: 10, alignItems: "center" }}>
          <a href="/login" className="ff-nav" style={{
          ...
          <button className="ff-hamburger" onClick={() => {
            const menu = document.getElementById('ff-mobile-menu');
        ...
        <div id="ff-mobile-menu" style={{
          display: "none", position: "absolute", top: "100%", left: 0, right: 0,
          background: "rgba(8,12,20,0.97)", backdropFilter: "blur(16px)",
          borderBottom: "1px solid rgba(255,255,255,0.06)",
          flexDirection: "column", padding: "16px 24px", gap: 4,
        }}>
          {[
          ...
          <a href="/login" style={{ fontSize: 15, color: "#94A3B8", textDecoration: "none", fontWeight: 500, padding: "12px 0" }}>Login</a>
        </div>
      </header>
